												...
												<tr>
													<td valign="top" class="bodyContent">
														<div mc:edit="std_content00">
															...
															<strong>
																Hola! {{$order->email}}
															</strong> Se actualizó la información de tu pedido, a continuación mostramos los datos actualizados
														</div>
													</td>
												</tr>
												<tr>
													<td valign="top" style="padding-top:0; padding-bottom:0;">
														<table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
															...
															<tr>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content00">
																Si algun dato es erroneo por favor comunicarse con nosotros a 
																<a href="mailto:ebertmillgmail.com">ebertmill@gmail.com</a>
																</td>
															</tr>				
														</table>
													</td>
															...
															<tr>
																<td valign="middle" class="templateButtonContent">
																	<div mc:edit="std_content02">
																		<a href="{{url('/compras/'.$order->shoppingCartCustomID()) }}" target="_blank">Ver mas información de tu pedido</a>
																	</div>
																</td>
															</tr>
														</table>
												...
												<tr>
													<td valign="top">
														<div mc:edit="std_footer">
															<em>Copyright &copy; 2016 Decatlhon</em>
															<br />
															<strong>Our mailing address is:</strong>
															<br />
															ayuda ebert@gmail.com
														</div>
													</td>
												</tr>
